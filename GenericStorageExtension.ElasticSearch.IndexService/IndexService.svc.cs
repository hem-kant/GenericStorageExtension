...
using GenericStorageExtension.ESIndexService.BAL;
using System;
    ...
    public class IndexService : IIndexService
    {
        ...
        public GenericStorageExtensionServiceResponse<IndexResponse> AddDocument(GenericStorageExtensionServiceRequest<IndexRequest> query)
        {
            ...
            try
            {
                ...
                GenericStorageExtensionIndexManager indexManager = new GenericStorageExtensionIndexManager(language);
        ...
        public GenericStorageExtensionServiceResponse<IndexResponse> RemoveDocument(GenericStorageExtensionServiceRequest<IndexRequest> query)
        {
            ...
            try
            {
                ...
                IndexResponse resultValue;
                GenericStorageExtensionIndexManager indexManager = new GenericStorageExtensionIndexManager(query.ServicePayload.LanguageInRequest);
